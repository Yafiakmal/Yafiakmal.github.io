export default function MyProfile() {
    return (
        <section className="bg-blue-100 w-full h-[530px] px-[60px] grid grid-cols-7 grid-rows-7 font-mono">
            ...
            <div className="col-span-3 row-span-full px-[30px] flex flex-col justify-center items-center ">
                <div className="relative h-full w-full flex justify-center items-center">
                    <div className="absolute bottom-0 h-[80%] w-[55%] lg:w-[40%] left-1/2 -translate-x-1/2 rounded-t-lg bg-linear-to-br from-[#1D546C] to-[#38A3D2]"></div>
